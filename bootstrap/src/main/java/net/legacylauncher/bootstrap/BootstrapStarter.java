...
public final class BootstrapStarter {
    ...
    private static List<String> loadJvmArgs() {
        ...
        jvmArgs.add("-XX:CICompilerCount=2");
        jvmArgs.add("-Xss256k");
        jvmArgs.add("-XX:MinHeapFreeRatio=10");
        jvmArgs.add("-XX:MaxHeapFreeRatio=20");
        jvmArgs.add("-XX:MaxMetaspaceSize=64m");
        jvmArgs.add("-XX:ReservedCodeCacheSize=32m");
        jvmArgs.add("-XX:CompressedClassSpaceSize=16m");
