...
*/
    ...
    private void addCommonOptimizedArguments(List<String> args) {
        ...
        args.add("-Dio.netty.allocator.type=pooled");
    ...
    private void addOptimizedArguments(List<String> args, JavaManagerConfig.OptimizedArgsType argsType) {
        ...
        // Auto-select Generational ZGC for Java 21+
        if (jreMajorVersion >= 21 && (argsType == JavaManagerConfig.OptimizedArgsType.DEFAULT || argsType == JavaManagerConfig.OptimizedArgsType.ZGC)) {
            log.info("Applying Generational ZGC optimization for Java {}", jreMajorVersion);
