...
public class MinecraftUIListener implements MinecraftListener, CrashManagerListener, LocalizableComponent {
    ...
    public void onMinecraftLaunch() {
        ...
        net.legacylauncher.util.MemoryOptimizer.trimMemory();
        try {
            String versionName = "Minecraft";
            if (t.getMinecraftLauncher() != null && t.getMinecraftLauncher().getVersion() != null) {
                versionName = t.getMinecraftLauncher().getVersion();
            }
            String playerName = "";
            if (t.getProfileManager() != null && t.getProfileManager().getAccountManager() != null) {
                net.legacylauncher.user.User u = t.getProfileManager().getAccountManager().getUserSet().getSelected();
                if (u != null) {
    ...
    public void onMinecraftClose() {
        try {
            net.legacylauncher.rpc.DiscordRPC.getInstance().setInLauncher();
        } catch (Throwable ignored) {
        }
